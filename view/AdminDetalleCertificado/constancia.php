      ...
      <div class="br-pagebody">
        ...
        <div class="br-section-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <select class="form select" style="width:100%" name="cur_id" id="cur_id" data-placeholder="Seleccione">
            ...
            <div class="table-wrapper"></div>
                <table  id="detalle_data"style="width:102%"  class="table-bordered table-responsive">
                <thead>
                    <tr>
                    <th class="wd-15p">Taller Inscrito</th>
                    <th class="wd-15p">Alumno Inscrito</th>
