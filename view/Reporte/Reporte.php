      ...
      <section>
          <div class="container">
                ...
                <form action="DescargarReporte_x_fecha.php" method="post" accept-charset="utf-8">
                  <div class="row">
                    ...
                    <div class="col">
                      ...
                      <button type="submit" class="btn btn-danger mb-2">Descargar en exel</button>
                    </div>
                  </div>
                </form>
              </div>
            ...
            <div class="table-responsive resultadoFiltro">
              <table class="table table-hover" id="tableEmpleados">
                <thead>
                  <tr>
                    ...
                    <th scope="col">seundo appelido</th>
              ...
              <?php
              include('config.php');
              $sqlTrabajadores = ('SELECT * FROM tm_usuario,tm_curso');
              ...
              $i =1;
                ...
                <tbody>
                  <tr>
                    ...
                    <td><?php echo $dataRow['cur_nom'] ; ?></td>
