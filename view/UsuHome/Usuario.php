...
<html lang="es">
  ...
  <link rel="stylesheet" href="asset/css/inciar_sesion.css">
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="bg-primary rounded overflow-hidden">
              <div class="pd-25 d-flex align-items-center">
                ...
                <div class="mg-l-20">
                  <p class="total">Total de Cursos</p>
            ...
            <div class="card pd-0 bd-0 shadow-base">
              <div class="pd-x-30 pd-t-30 pd-b-15">
                <div class="d-flex align-items-center justify-content-between">
                  <div>
                    <h6 class="lista0">Top Ultimos Cursos</h6>
                    <p class="lista">Aqui podra visualizar los ultimos 10 Certificados</p>
                  </div>
                </div>
              </div>
    ...
    <script type="text/javascript" src="HomeUsuario.js"></script>
  </body>
</html>
<?php
  }else{
